...
class BilibiliEncoder {
    #XOR_CODE: bigint = 23442827791579n
    #MASK_CODE: bigint = 2251799813685247n
    #MAX_AID: bigint = 1n << 51n
    #BASE: bigint = 58n
    #data: string = 'FcwAPNKTMug3GV5Lj7EJnHpWsx4tb8haYeviqBz6rkCy12mUSDQX9RdoZf'

    av2bv(aid: number | string): string {
