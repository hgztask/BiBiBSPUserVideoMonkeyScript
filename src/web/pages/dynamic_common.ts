...
import {blockCheckWhiteUserUid, blockDynamicItemContent} from "../domain/shielding_main.ts";
 ...
 * @returns {{}}
 */
const getDynamicCardModulesData = (vueData: any) => {
...
const checkEachItem = (dynamicData: any, ruleArrMap: any) => {
