 ...
 * @returns {boolean}
 */
const isUserSpaceDynamicPage = (url: any) => {
...
export default {
    ...
    //是否是用户空间投稿页面
    isUserSpaceUploadPage(url: string) {
     ...
     */
    setChargingVideosVisible(visible: boolean) {
     ...
     * 设置用户空间中动态列表中直播回放的显隐
     */
    setLiveReplayVideosVisible(visible: boolean) {
